#ifndef _v2_VEHA_Behavior_BasicActions_SignalWidgetAction_H
#define _v2_VEHA_Behavior_BasicActions_SignalWidgetAction_H
...
namespace VEHA
{
  ...
  class VEHA_API SignalWidgetAction : public Action
  {
  public :
    SignalWidgetAction();
    virtual ~SignalWidgetAction();
  protected :
