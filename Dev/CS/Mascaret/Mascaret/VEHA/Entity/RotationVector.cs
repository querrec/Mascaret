...
public class RotationVector : ValueSpecification
{
	...
	public RotationVector(double x, double y, double z, double a) : base(MascaretApplication.Instance.Model.getBasicType("rotation"))
	...
	public RotationVector(Vector3 v, double a) :base(MascaretApplication.Instance.Model.getBasicType("rotation"))
	...
	public RotationVector(string str) : base(MascaretApplication.Instance.Model.getBasicType("rotation"))
