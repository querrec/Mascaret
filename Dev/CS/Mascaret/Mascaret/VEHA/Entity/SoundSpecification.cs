...
public abstract class SoundSpecification : VirtualRealitySpecification
{
	...
	public SoundSpecification(string name, string url, double gain, double minDistance, double maxDistance, bool cycle) : base(MascaretApplication.Instance.Model.getBasicType("sound"))
