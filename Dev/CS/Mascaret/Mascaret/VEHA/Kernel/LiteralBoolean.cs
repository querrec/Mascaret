...
public class LiteralBoolean : LiteralSpecification
{
	...
	public LiteralBoolean() : base(MascaretApplication.Instance.Model.getBasicType("boolean"))
	{
	}
	
	public LiteralBoolean(bool b) : base(MascaretApplication.Instance.Model.getBasicType("boolean"))
	{
		bValue = b;
	}
	
	public LiteralBoolean(string svalue) : base(MascaretApplication.Instance.Model.getBasicType("boolean"))
