...
public class LiteralString : LiteralSpecification
{
	...
	public LiteralString (string svalue) : base(MascaretApplication.Instance.Model.getBasicType("string"))

	{		
		sValue = svalue;
	}
	
	public LiteralString() : base(MascaretApplication.Instance.Model.getBasicType("string"))
	{
	}
