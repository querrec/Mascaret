...
public class LiteralReal : LiteralSpecification
{
	...
	public LiteralReal () : base(MascaretApplication.Instance.Model.getBasicType("real"))
	{
	}
	
	public LiteralReal(string svalue) : base(MascaretApplication.Instance.Model.getBasicType("real"))

	{	
		setValueFromString (svalue);
	}
	
	public LiteralReal(double r) : base(MascaretApplication.Instance.Model.getBasicType("real"))
