...
public class CallOperationBehaviorExecution : BehaviorExecution
{
	...
	public CallOperationBehaviorExecution(CallOperationAction paction, InstanceSpecification host, Dictionary<string,ValueSpecification> p) : base(paction, host,p, false)
