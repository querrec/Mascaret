...
//		Debug.Log(" current token : " + token.currentLocation.name);
	...
	protected void buildAffectationsObject(ref List<string> missing, ActivityNode node)
	{
		...
		//Debug.Log("TRY TO AFFECT OBJECT : " + pname);
		...
		if(ra != null && ra.Entity != null)
		{
			...
			System.Console.WriteLine("SUCCESS TO AFFECT OBJECT : " + pname);
		}
		else
		{
			...
			{
				System.Console.WriteLine("FAIL TO AFFECT OBJECT : " + pname);
				missing.Add(pname);
			}
		}
	}
	...
	public List<ActionNode> getActionToExecuteForAll()
	{
		...
		//	Debug.Log(" NB ACTIVE TOKENS : " + activeTokens.Count);
